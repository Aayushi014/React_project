...
const Createtask = () => {
  ...
  const submitHandler = (e) =>{
    ...
    setNewTask({taskTitle, taskDate, taskCategory, taskDescription,active: false,newTask:true, completed: false, failed: false});
    const data = JSON.parse(localStorage.getItem("emplo"));
    setTaskTitle("");
    setTaskDate("");
    setTaskAssign("");
    setTaskCategory("");
