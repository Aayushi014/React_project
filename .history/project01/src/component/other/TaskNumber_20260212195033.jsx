...
const TaskNumber = () => {
  return (
    <div className='flex flex-wrap justify-between gap-5 mt-10'>
        <div className='bg-emerald-200 rounded w-1/2 md:w-1/2 text-black py-6 px-8'>
        ...
        <div className='bg-emerald-200 rounded w-f md:w-1/2 text-black py-6 px-8'>
           <h1 className='font-bold text-3xl'>0</h1>
           <h1 className=' text-xl'>Accepted</h1>
        </div>
         <div className='bg-emerald-200 rounded w-full md:w-1/2 text-black py-6 px-8'>
           <h1 className='font-bold text-3xl'>0</h1>
