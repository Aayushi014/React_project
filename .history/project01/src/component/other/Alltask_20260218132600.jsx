...
const Alltask = ({data}) => {
  return (
    <div id = "alltask" className = " py-10 w-full h-screen">
      <div className='bg--400 mb-2 py-2 px-4 rounded flex justify-between'>
     ...
     <div>
        {data.employees.map(function(elem){
            return <div className='border-2 border-emerald-400 mb-2 py-2 px-4 rounded flex justify-between overflow-auto'>
