...
const CompleteTask = () => {
  return (
    <div className = "shrink-0 bg-green-200 w-75 h-full rounded-lg overflow-hidden flex flex-col justify-between gap-1 p-4">
        ...
        <div>
            <button className = "bg-red-500 rounded w-full active:scale-90 cursor-pointer">Completed</button>
        </div>
    </div>
  )
}
