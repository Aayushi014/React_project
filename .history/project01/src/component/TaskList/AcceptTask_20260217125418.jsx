  ...
  return (
    <div className = "shrink-0 bg-blue-200 w-75 h-full rounded-lg overflow-hidden p-4">
        ...
        <div className='flex justify-between mt-10 gap-1'>
            <button className = "bg-emerald-500 rounded w-full active:scale-90 cursor-pointer">Mark as completed</button>
            <button className = "bg-red-400 rounded w-full active:scale-90 cursor-pointer">Mark as rejected</button>
        </div>
    </div>
  )
}
