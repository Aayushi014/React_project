...
const AcceptTask = () => {
  return (
    <div className = "shrink-0 bg-blue-200 w-75 h-full rounded-lg overflow-hidden p-4">
        ...
        <div>
            <button className = "bg-emerald-600 mt-2 p-1 rounded w-full active:scale-90 cursor-pointer">Accept</button>
            <button className = "bg-red-600 mt-2 p-1 rounded w-full active:scale-90 cursor-pointer">Reject</button>
         </div>
        </div>
      </div>
  )
