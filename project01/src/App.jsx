...
const refreshUserData = () => {
  if(user === "employee" && loggedInUserData) {
    ...
    const updatedEmployee = employees.find(emp => emp.id === loggedInUserData.id);
    if(updatedEmployee) {
...
const handleLogin = (email,password) => {
  ...
  return (
    <div>
      ...
      {user === "admin" ? <AdminDashboard changeUser = {setUser}/> : user === "employee" ? <EmployeeDasboard data={loggedInUserData} changeUser={setUser} onTaskCreated={refreshUserData}/> : null}
    </div>
  )
}
